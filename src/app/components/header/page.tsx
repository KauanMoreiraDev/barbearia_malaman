        ...
        <header className="w-screen h-32 bg-white">
            <div className="mx-auto max-w-screen-lg">
                <div className="flex justify-between items-center">
                    ...
                    <div className="block sm:hidden p-2 mx-3 relative z-50">
                        <button onClick={() => setOpen(!open)} className="w-full h-full">
                            {open ? <Image src={'/images/cardapio.png'} alt="abrir menu" width={30} height={30} /> : <div className="flex flex-col items-end">
                                <Image src={'/images/x.png'} alt="fecha menu" width={30} height={30} />
